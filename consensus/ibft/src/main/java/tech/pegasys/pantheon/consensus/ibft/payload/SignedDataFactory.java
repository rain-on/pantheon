...
public class SignedDataFactory {

  private final KeyPair validatorKeyPair;

  public SignedDataFactory(final KeyPair validatorKeyPair) {
    this.validatorKeyPair = validatorKeyPair;
  }

  public SignedData<ProposalPayload> createProposal(
  ...
  public SignedData<PreparePayload> createPrepare(
  ...
  public SignedData<CommitPayload> createCommit(
  ...
  public SignedData<RoundChangePayload> createRoundChange(
      final ConsensusRoundIdentifier roundIdentifier,
  ...
  public SignedData<NewRoundPayload> createNewRound(
      final ConsensusRoundIdentifier roundIdentifier,
